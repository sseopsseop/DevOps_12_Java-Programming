...
public enum Season {
	...
	private int[] seasonMonths = new int[3];
	
	private Season(String seasonStr, int seasonMonth0, int seasonMonth1, int seasonMonth2) {
	...
	public void printSeasonMonths() {
		System.out.print(this.seasonStr + "는(은) ");
