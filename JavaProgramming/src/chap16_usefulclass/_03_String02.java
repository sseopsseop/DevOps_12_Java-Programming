...
public class _03_String02 {
	public static void main(String[] args) {
		...
		// String은 space 값도 문자열 값으로 인식(index로 잡힌다.)
		...
		System.out.println("str3에서 마지막 b의 index는 "+ str3.lastIndexOf('b'));
		
		// 3. length : 문자열의 길이를 리턴하는 메소드
		System.out.println("str3의 길이는 " + str3.length());
		
		// 배열에서는 length가 메소드가 아니고 속성 값(멤버 변수)이다.
