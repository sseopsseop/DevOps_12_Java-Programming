...
public class CarConstructor {
	...
	// 생성자를 정의하지 않았을 때 기본으로 제공된다.
	// 생성자는 객체를 생서하면서 속성들을 초기화할 때 주로 사용한다.
	...
	// 매개변수가 있는 생성자는 받아온 매개변수 값으로 클래스의 속성들을 초기화한다.
	// 매개변수는 생성자에서 어떤 변수를 초기화하는 지 명확하게 하기 위해서
	// 속성 변수명과 일치시키는 게 관례적이다.
