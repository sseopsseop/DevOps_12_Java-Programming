...
public class _04_ReturnLambda {
	public static void main(String[] args) {
		...
		// 중괄호블록에서 return 구문을 사용하지 않으면 에러가 발생한다.
		// 처리하는 내용이 한 줄이거나 여러 줄일 때 모두 사용가능
...
//		);
		...
		// 처리할 내용이 여러 줄일 때는 중괄호블록으로 묶고 리턴 구문을 사용한다.
		result = conc((st1, st2) -> 
		{
			System.out.println(st1); 
			System.out.println(st2);
...
//		result = conc((str1, str2) -> str1 + str2;);
	...
	public static String conc(String str1, String str2, ConcatString concatString) {
