...
public class _07_LambdaEx03 {
	public static void main(String[] args) {
		...
		int resultVal = calc(
				...
				(intVal1, intVal2, operator) -> {
				int res = 0;
				
				switch(operator.charAt(0)) {
				case '+': res = intVal1 + intVal2; break;
				case '-': res = intVal1 - intVal2; break;
				case '*': res = intVal1 * intVal2; break;
				case '/': res = intVal1 / intVal2; break;
				case '%': res = intVal1 % intVal2; break;
		...
		System.out.println("결과 값 : " + resultVal);
	}
	
	public static int calc(BasicCalculator basicCalculator) {
		// 정수 두개 입력받고
		// +, -, *, /, % String 타입으로 입력 받아서
		// basicCalculator의 calculate 메소드를 호출하도록 구현하세요.
		...
		int res = basicCalculator.calculate(num1, num2, operator);
